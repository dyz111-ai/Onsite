...
training_competition_bp = Blueprint('training_competition', __name__, url_prefix='/api/competition')


@training_competition_bp.route('/list', methods=['GET'])
@token_required
...
@training_competition_bp.route('/select', methods=['POST'])
@token_required
